...
# from propelauth_fastapi import init_auth, Users
...
# def create_new_user(current_user: Users = Depends(auth.require_user), db: Session = Depends(get_db)):
#     try:
...
#
#
# @router.post("/users/update", response_model=schemas.Users)
